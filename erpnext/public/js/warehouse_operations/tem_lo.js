...
// không xem trước gì.
//
// Nạp bằng `frappe.require("/assets/erpnext/js/warehouse_operations/tem_lo.js")`. CỐ Ý
...
//
// File này PHỤ THUỘC `tem_vi_tri.js` (dùng `erpnext.warehouse_operations.tem
...
// có `erpnext/warehouse_operations/vitri/ma_vach.py` cho phía máy chủ, và hai bản cài
...
erpnext.warehouse_operations.tem_lo = (function () {
...
`;
	 ...
	 */
	function may_vach() {
		if (!erpnext.warehouse_operations.tem || !erpnext.warehouse_operations.tem.may_ve_ma_vach) {
			frappe.throw(
				__(
					"Chưa nạp tem_vi_tri.js — gọi frappe.require('/assets/erpnext/js/warehouse_operations/tem_vi_tri.js') trước tem_lo.js."
				)
			);
		}
		return erpnext.warehouse_operations.tem.may_ve_ma_vach();
	}
