...
class TestCotViTriLay(FrappeTestCase):
	...
	def test_tach_dong_moi_dong_co_cot_rieng(self):
		from erpnext.vi_tri_kho.tests.test_lay_hang import _chuyen_vao_o_lo, _nhap_kho_lo
...
class TestTienDoLayHang(FrappeTestCase):
	...
	def test_chua_lay(self):
		from erpnext.vi_tri_kho.vitri.lay_hang import tien_do_lay_hang
	...
	def test_dang_lay_roi_du(self):
		from erpnext.vi_tri_kho.vitri.lay_hang import ghi_da_lay, tien_do_lay_hang
	...
	def test_chot_thieu_dem_rieng_va_coi_nhu_xong(self):
		from erpnext.vi_tri_kho.vitri.lay_hang import chot_thieu, ghi_da_lay, tien_do_lay_hang
	...
	def test_da_duyet_theo_quet_va_theo_fefo(self):
		from erpnext.vi_tri_kho.vitri.lay_hang import ghi_da_lay, hoan_tat, tien_do_lay_hang
