...
//   `public/js/warehouse_operations/tem_vi_tri.js` — VẼ con tem      (dùng chung 3 chỗ)
...
function mo_hop_in_tem(goc) {
	frappe.call({
		method: "erpnext.warehouse_operations.vitri.tem.danh_sach_tem",
...
function hop_thoai(goc, danh_sach) {
	const tem = erpnext.warehouse_operations.tem;
