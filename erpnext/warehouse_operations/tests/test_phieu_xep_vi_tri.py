...
class TestBayF8TrongNhanhBiTat(FrappeTestCase):
	...
	def test_hai_ban_ghi_chua_hoi_tu_khong_coi_nhau_la_to_tien(self):
		from erpnext.warehouse_operations.vitri.cay import nhanh_bi_tat
...
class TestLayHangChuaXep(_BoKiemOTem, FrappeTestCase):
	...
	def test_ma_rat_dai_khong_lam_no_luoi_an_toan(self):
		...
		chỉ một dòng.
		"""
		from erpnext.warehouse_operations.vitri import xep as xep_mod
		from erpnext.warehouse_operations.vitri.goi_y import goi_y_o as goi_y_o_that
