...
in) nằm trọn trong `public/js/warehouse_operations/tem_vi_tri.js` — bộ test này là
...
from erpnext.warehouse_operations.vitri.tem import TRAN_SO_TEM, danh_sach_tem
