...
from erpnext.warehouse_operations.tests.kho_thu import dam_bao_kho_thu
...
from erpnext.warehouse_operations.vitri.bat_kho import bat, xem_truoc
from erpnext.warehouse_operations.vitri.doi_soat import NGUONG_SAI_SO, doi_soat_kho, ton_kho_theo_lo
...
class TestBatThatBai(FrappeTestCase):
	...
	def test_bat_that_bai_khong_de_lai_dau_vet(self):
		...
		with patch(
			"erpnext.warehouse_operations.vitri.bat_kho.doi_soat_kho",
			return_value={
				"kho": KHO,
				"khop": False,
				"so_dong_lech": 1,
