...
class TestPatchDonLoaiViTriKhongHopLe(_CoTienDeKho):
	...
	def test_patch_xoa_custom_field_ma_kho_spd(self):
		...
		`warehouse_operations` treo lên. Bài này khoá cả hai vế.
		"""
		from erpnext.patches.v15_0.don_loai_vi_tri_khong_hop_le import execute
...
class TestDamBaoCayDaDung(_CoTienDeKho):
	"""`erpnext.warehouse_operations.vitri.cay.dam_bao_cay_da_dung` — Task 8, vòng sửa 2/5.
	...
	def test_bo_qua_khong_rebuild_khi_con_o_dang_tat(self):
		...
		import erpnext.warehouse_operations.vitri.cay as cay_module
...
class TestManHinhMaVach(FrappeTestCase):
	...
	def test_o_chua_xep_that_su_khong_theo_chuan_10_ky_tu(self):
		...
		"""
		from erpnext.warehouse_operations.vitri.ma_vi_tri import MAU_MA
