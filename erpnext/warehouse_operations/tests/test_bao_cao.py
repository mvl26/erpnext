...
from erpnext.warehouse_operations.tests.test_hook_nhap import _nhap_kho as _nhap
...
class TestBaoCaoTonTheoViTri(FrappeTestCase):
	...
	def test_gop_theo_khu_bang_tong_cac_o_la(self):
		...
		from erpnext.warehouse_operations.report.ton_kho_theo_vi_tri import ton_kho_theo_vi_tri
...
class TestBaoCaoHangChuaXep(FrappeTestCase):
	...
	def test_liet_ke_hang_o_chua_xep(self):
		from erpnext.warehouse_operations.report.hang_chua_xep_vi_tri.hang_chua_xep_vi_tri import execute
...
class TestBaoCaoDoiSoat(FrappeTestCase):
	...
	def test_thieu_filter_kho_bi_chan(self):
		from erpnext.warehouse_operations.report.doi_soat_ton_vi_tri.doi_soat_ton_vi_tri import execute
